...
var SFProduct_1 = require("../models/SFProduct");
var jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
var productStore = new SFProduct_1.ProductStore();
var getAllProduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var products;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, productStore.indexProduct()];
            case 1:
                products = _a.sent();
                res.json(products);
                return [2 /*return*/];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, productStore.createProduct({ name: name, price: price })];
            case 1:
                product = _a.sent();
                res.json({
                    product: product,
...
var readProduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, productStore.showProduct(id)];
            case 1:
                product = _a.sent();
                res.json(product);
                return [3 /*break*/, 3];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                name = req.body.name;
                price = req.body.price;
                return [4 /*yield*/, productStore.updateProduct(id, {
                        name: name,
                        price: price,
                    })];
            case 1:
