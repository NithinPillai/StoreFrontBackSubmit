...
var SFOrder_1 = require("../models/SFOrder");
var jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
var store = new SFOrder_1.StorefrontOrderStore();
var indexOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var orders;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, store.indexOrder()];
            case 1:
                orders = _a.sent();
                res.json(orders);
                return [2 /*return*/];
...
var createOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var products, status, user_id, order;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, store.createOrder({
                        products: products,
                        status: status,
                        user_id: user_id,
                    })];
...
var readOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, order;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, store.readOrder(id)];
            case 1:
                order = _a.sent();
                res.json(order);
                return [2 /*return*/];
...
var updateOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, products, status, user_id, order;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                ...
                status = req.body.status;
                user_id = req.body.user_id;
                return [4 /*yield*/, store.updateOrder(id, {
                        products: products,
                        status: status,
                        user_id: user_id,
                    })];
...
var deleteOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, store.deleteOrder(id)];
            case 1:
                _a.sent();
